...
mods.tconstruct.Smeltery.addMelting(<liquid:iron> * 2592, <extrautils2:spike_iron>, 400);
//mods.tconstruct.Smeltery.addMelting(<liquid:iron> * 2304, <mob_grinding_utils:spikes>);
mods.tconstruct.Smeltery.addMelting(<liquid:gold> * 2592, <extrautils2:spike_gold>, 400);
